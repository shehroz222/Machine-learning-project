...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            " See Accelerator::save_state https://huggingface.co/docs/accelerate/package_reference/accelerator
            " for more docs"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            " more information see https://huggingface.co/docs/accelerate/v0.17.0/en/package_reference/accelerator
        ),
    )
